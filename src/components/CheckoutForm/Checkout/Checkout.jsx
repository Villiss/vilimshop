...
const steps = ['Adresa dodania', 'Platobné údaje'];
    ...
    let Confirmation = () => order.customer ? (
        <>
            <div>
                ...
                <Typography variant="subtitle2">Číslo objednávky: {order.customer_reference}</Typography>
            </div>
            <br />
            <Button component={Link} to="/" variant="outlined" type="button">Späť domov</Button>
        </>
    ) : isFinished ? (
        <>
            <div>
                <Typography variant="h5">Ďakujeme Vám za Vašu objednávku</Typography>
                <Divider className={classes.divider} />
            </div>
            <br />
            <Button component={Link} to="/" variant="outlined" type="button">Späť domov</Button>
